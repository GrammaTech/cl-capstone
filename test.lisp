...
(deftest operands.arm ()
   (is (equal (operands (make-instance 'capstone-instruction/arm-a32 :mnemonic :bx :op-str "lr")) '(:LR)))
   (is (equal (operands (make-instance 'capstone-instruction/arm-a32 :mnemonic :cmp :op-str "r4, r5")) '(:R4 :R5)))
   (is (equal (operands (make-instance 'capstone-instruction/arm-a32 :mnemonic :ldr :op-str "r2, [r3]")) '(:R2 (:DEREF :R3))))
   (is (equal (operands (make-instance 'capstone-instruction/arm-a32 :mnemonic :ldr :op-str "r2, [sp, #8]")) '(:R2 (:DEREF (:+ :SP 8)))))
   (is (equal (operands (make-instance 'capstone-instruction/arm-a32 :mnemonic :ldr :op-str "r2, [pc, #x10]")) '(:R2 (:DEREF (:+ :PC 16)))))
   (is (equal (operands (make-instance 'capstone-instruction/arm-a32 :mnemonic :ldr :op-str "r2, [pc, #-0x10]")) '(:R2 (:DEREF (:+ :PC -16)))))
   (is (equal (operands (make-instance 'capstone-instruction/arm-a32 :mnemonic :strd :op-str "r4, [r7], -r8")) '(:R4 (:DEREF :R7) (:NEG :R8))))
   (is (equal (operands (make-instance 'capstone-instruction/arm-a32 :mnemonic :push :op-str "{r4, lr}")) '((:REGSET (:R4 :LR)))))
   (is (equal (operands (make-instance 'capstone-instruction/arm-a32 :mnemonic :andeq :op-str "r7, r8, r8, lsr #11")) '(:R7 :R8 (:LSR :R8 11))))
)

(deftest operands.thumb ()
   (is (equal (operands (make-instance 'capstone-instruction/arm-t32 :mnemonic :bx :op-str "lr")) '(:LR)))
   (is (equal (operands (make-instance 'capstone-instruction/arm-t32 :mnemonic :cmp :op-str "r4, r5")) '(:R4 :R5)))
   (is (equal (operands (make-instance 'capstone-instruction/arm-t32 :mnemonic :ldr :op-str "r2, [r3]")) '(:R2 (:DEREF :R3))))
   (is (equal (operands (make-instance 'capstone-instruction/arm-t32 :mnemonic :ldr :op-str "r2, [sp, #8]")) '(:R2 (:DEREF (:+ :SP 8)))))
   (is (equal (operands (make-instance 'capstone-instruction/arm-t32 :mnemonic :ldr :op-str "r2, [pc, #x10]")) '(:R2 (:DEREF (:+ :PC 16)))))
   (is (equal (operands (make-instance 'capstone-instruction/arm-t32 :mnemonic :ldr :op-str "r2, [pc, #-0x10]")) '(:R2 (:DEREF (:+ :PC -16)))))
   (is (equal (operands (make-instance 'capstone-instruction/arm-t32 :mnemonic :strd :op-str "r4, [r7], -r8")) '(:R4 (:DEREF :R7) (:NEG :R8))))
   (is (equal (operands (make-instance 'capstone-instruction/arm-t32 :mnemonic :push :op-str "{r4, lr}")) '((:REGSET (:R4 :LR)))))
)
...
(deftest parse-capstone-operand.bad-syntax.arm ()
  (let ((insn (make-instance 'capstone-instruction/arm-a32)))
    (is (equal (opstring-to-tokens insn "1A") '("1A")))
    (is (equal (opstring-to-tokens insn "-2B") '("-2B")))
    (is (equal (opstring-to-tokens insn "0x1H") '("0x1H")))
    (is (equal (opstring-to-tokens insn "-0x") '("-0x")))
